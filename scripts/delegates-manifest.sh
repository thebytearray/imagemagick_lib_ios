...
export DM_ZLIB_URL="https://zlib.net/fossils/zlib-${DM_ZLIB_VERSION}.tar.gz"
...
export DM_LCMS2_URL="https://downloads.sourceforge.net/project/lcms/lcms/${DM_LCMS2_VERSION}/lcms2-${DM_LCMS2_VERSION}.tar.gz"

export DM_OPENJPEG_VERSION="${DM_OPENJPEG_VERSION:-2.3.1}"
export DM_OPENJPEG_DIR="openjpeg-${DM_OPENJPEG_VERSION}"
export DM_OPENJPEG_URL="https://github.com/uclouvain/openjpeg/archive/refs/tags/v${DM_OPENJPEG_VERSION}.tar.gz"

export DM_PNG_VERSION="${DM_PNG_VERSION:-1.6.44}"
export DM_PNG_DIR="libpng-${DM_PNG_VERSION}"
export DM_PNG_URL="https://downloads.sourceforge.net/project/libpng/libpng16/${DM_PNG_VERSION}/libpng-${DM_PNG_VERSION}.tar.xz"
